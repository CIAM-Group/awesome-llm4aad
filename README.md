...
| 2024.10 | [**LLaMEA-HPO** — In-the-loop Hyper-Parameter Optimization for LLM-Based Automated Design of Heuristics](https://arxiv.org/pdf/2410.16309) | ACM TELO 2025 | `OBP`, `Black-Box Optimization`, `TSP` | Search | [Note](content/papers/llamea-hpo/index.md) · [Code](https://zenodo.org/records/14917719) |
